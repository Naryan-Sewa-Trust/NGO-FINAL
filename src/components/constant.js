const texts = [
  ...
  },
  {
    ...
    description:
      "At Narayan Sewa Trust, we hold a profound respect for the elderly, recognizing them as the pillars of our society who have spent their lives nurturing and guiding the younger generations. Our mission is deeply rooted in the belief that every elderly individual deserves to live their golden years with dignity, respect, and love. Unfortunately, many elderly parents find themselves abandoned by their children and left in old age homes, facing loneliness and neglect. At Narayan Sewa Trust, we are committed to changing this narrative. We strive to create a sanctuary where these venerable members of our community can find solace and companionship. Our dedicated team works tirelessly to provide not only the basic necessities but also emotional and psychological support, ensuring that they feel valued and cherished. We offer a range of services designed to enhance their quality of life, from healthcare and recreational activities to social engagement and spiritual support. By fostering a nurturing and supportive environment, we aim to restore their sense of purpose and joy. At Narayan Sewa Trust, we believe that every elderly person deserves to live with the dignity and care they rightfully deserve, and we are dedicated to making this vision a reality.",
  },
  {
    title: "Mass Wedding",
    description:
